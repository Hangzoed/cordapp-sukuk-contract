...
import com.sukuk_1.flows.TemplateInitiator;
...
public class CreateAndIssueSukTest {
    ...
    public void CreateAndIssueAppleStampTest() {
        CreateAndIssueVouchers.CreateAndIssueVouchersInitiator flow1 =
        ...
        Suk state = b.getServices().getVaultService()
                .queryBy(Suk.class, inputCriteria).getStates().get(0).getState().getData();
        assert (state.getVoucherDesc().equals("HoneyCrispy 4072"));
    }
}
